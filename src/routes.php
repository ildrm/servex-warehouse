...
The routes are handled by ETLController with corresponding service layer implementation:
- ETLController manages the HTTP layer
- ETLService handles business logic
- Storage class manages data persistence
